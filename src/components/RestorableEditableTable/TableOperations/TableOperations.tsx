  ...
  return (
    <React.Fragment>
      <If
        ...
        then={() => (
          <Fragment>
            ...
            >
              <FormattedMessage key="TableAction.Edit" defaultMessage="Edit" />
            </Button>
      ...
      >
        <If
          condition={toDelete}
          then={() => <FormattedMessage key="TableAction.Recover" defaultMessage="Restore" />}
          else={() => <FormattedMessage key="TableAction.Delete" defaultMessage="Remove" />}
        />
      </Button>
    </React.Fragment>
  );
